...
namespace Launchpad.Devices
{
	...
	{
		private LaunchpadDevice _LaunchpadDevice;
		...
		{
			if (_RedBrightness == red && _GreenBrightness == green)
				return;
		...
		public ButtonBrightness RedBrightness
		{
			...
			internal set { _RedBrightness = value; }
		}

		public ButtonBrightness GreenBrightness
		{
			get { return _GreenBrightness; }
			internal set { _GreenBrightness = value; }
		}
